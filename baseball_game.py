...
def get_not_duplicated_three_digit_number():
    ...
    while True:
        user_input_number = str(get_random_number())
...
def main():
    ...
    while(user_input_number!=random_number):
        ...
        if user_input_number =='0':
            ...
            break
        if is_validated_number(user_input_number)==True:
            a=get_strikes_or_ball(user_input_number, random_number)
            print("Strikes:", a[0], "Balls:", a[1])
            while a[0] ==3:
                ...
                if is_yes(answer)==True:
                    ...
                    print("Thank you for using this program")
                    print("End of the Game")
                    user_input_number=random_number
                    break
                else:
                    print("Wrong Input, Input again")

        elif is_validated_number(user_input_number)==False or is_duplicated_number(user_input_number)==False:
            print("Wrong Input, Input agian")
    # ==================================
