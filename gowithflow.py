...
def merge_and_sort(list_data_a, list_data_b):
    ...
    result = sorted((list_data_a)+(list_data_b))

    # ==================================
    return result
##result = Nonlist_data_a + list_data_b
##return result.sort()
...
def discount_price(price):
    ...
    if int(price)<100000 :
        result=((1-0.1)*int(price))
    else:
        result=((1-0.2)*int(price))
    # ==================================
    return result
...
#===========================================================
    #return sorted(list_data)[0]
#===============================================
#smallest_value=list_data[0]
#for value in list_dat[1:]:
#if value<smallest_value:
#smallest_value=element_value
#return find_smallest_value
# ==================================
    return result
...
#for decimal_number //2 >0:
    #value=str(decimal_number%2)
